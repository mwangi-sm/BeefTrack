...
export function DistributorSignup({ onSubmit = () => {}, onBack = () => {}, onLogin = () => {} }) {
  ...
  function validate() {
    ...
    if (!form.address.trim()) e.address = 'Warehouse / depot address is required.'
  ...
  function handleSubmit(e) {
    ...
    if (Object.keys(v).length === 0) {
      ...
      onSubmit({ role: 'distributor', ...rest })
    }
  }

  return (
    <SignupShell
      badgeIcon={IconPaths.warehouse}
      badgeLabel="Distributor"
      title="Register your company"
      subtitle="Sign up to manage inventory and deliveries across the supply chain."
      onBack={onBack}
      onLogin={onLogin}
    >
      <form onSubmit={handleSubmit}>
        <div className="field">
          ...
          <input value={form.companyName} onChange={set('companyName')} placeholder="e.g. Nairobi Cold Chain Distributors Ltd" />
        ...
        <div className="field">
          <label>Warehouse / depot address</label>
        ...
        <div className="field">
          <label>Email</label>
          <input type="email" value={form.email} onChange={set('email')} placeholder="name@company.co.ke" />
        ...
        <button type="submit" className="btn btn-primary">
          <Icon size={16}>{IconPaths.warehouse}</Icon>
