...
export function ProcessorSignup({ onSubmit = () => {}, onBack = () => {}, onLogin = () => {} }) {
  ...
  function handleSubmit(e) {
    ...
    if (Object.keys(v).length === 0) {
      ...
      onSubmit({ role: 'processor', ...rest })
    }
  }

  return (
    <SignupShell
      badgeIcon={IconPaths.cut}
      badgeLabel="Processor"
      title="Register your facility"
      subtitle="Sign up your processing facility to cut, package and label product."
      onBack={onBack}
      onLogin={onLogin}
    >
      <form onSubmit={handleSubmit}>
        <div className="field">
          ...
          <input value={form.facilityName} onChange={set('facilityName')} placeholder="e.g. Ruiru Meat Processors Ltd" />
          {errors.facilityName && <FieldError>{errors.facilityName}</FieldError>}
        </div>

        <div className="field-row">
          <div className="field">
            <label>License number</label>
            <input value={form.licenseNumber} onChange={set('licenseNumber')} placeholder="e.g. KEBS/PR/2024-118" />
            {errors.licenseNumber && <FieldError>{errors.licenseNumber}</FieldError>}
          </div>
          <div className="field">
            <label>County</label>
        ...
        <button type="submit" className="btn btn-primary">
          <Icon size={16}>{IconPaths.cut}</Icon>
...
export default ProcessorSignup