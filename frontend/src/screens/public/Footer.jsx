      ...
      <div className="footer-grid">
        ...
        <div className="footer-col">
          ...
          <ul>
            ...
            <li><button onClick={onEnroll}>Get Started</button></li>
            <li><button onClick={onLogin}>Sign In</button></li>
          </ul>
        </div>
        ...
        <div className="footer-col">
          ...
          <p className="footer-note">
            Built at Jomo Kenyatta University of Agriculture and Technology.
          </p>
        </div>
      </div>
