    ...
    <>
      ...
      {!loading && (
        <>
          ...
          <Panel title="Facility Licences & Certifications">
            <p style={{ fontSize: 12, color: 'var(--ink-600)', margin: '0 0 14px' }}>
              Core operating documents required by law. Must be current and verified.
            </p>
          ...
          <Panel title="Personnel Certifications">
            <p style={{ fontSize: 12, color: 'var(--ink-600)', margin: '0 0 14px' }}>
          ...
          <Panel title="Optional Documents">
            <p style={{ fontSize: 12, color: 'var(--ink-600)', margin: '0 0 14px' }}>
              Supplementary documents that support your facility's compliance profile.
            </p>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
              {OPTIONAL_DOCS.map((d) => (
                <DocumentRow
